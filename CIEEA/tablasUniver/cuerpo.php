...
class tablacuerpo{
      ...
      <td align="center" ><a data-role="Asistencia"  aria-controls="BorrarCliente"
        href="Listas_Asistencias.php?id=<?php echo $row["id"] ?>"   data-id="<?php echo $row["id"] ?>"><i class="fa fa-child "></i></a></td>
           ...
           <td><a data-role="myModCliente"  aria-controls="collapseModificar" data-toggle="collapse" href="#collapseModificar" data-id="<?php echo $row["id"] ?>"><i class="fa fa-edit "></i></a></td>

          <td><a data-role="BorrarCliente"  aria-controls="BorrarCliente" data-toggle="collapse" href="#BorrarCliente" data-id="<?php echo $row["id"] ?>"><i class="fa fa-trash "></i></a></td>
                 <?php  }
        ...
        href="Listas_Calificaciones.php?id=<?php echo $row["id"] ?>"   data-id="<?php echo $row["id"] ?>"><i class="fa fa-child "></i></a></td>
          ...
          <td><a data-role="BorrarCliente"  aria-controls="BorrarCliente" data-toggle="collapse" href="#BorrarCliente" data-id="<?php echo $row["id"] ?>"><i class="fa fa-trash "></i></a></td>
           ...
           echo "<tr id=".$row['id'].">"; //hacen las filas
            ...
            if($link!=0){
          ?>
           <td><a data-role="myModCliente"  aria-controls="collapseModificar" data-toggle="collapse" href="#collapseModificar" data-id="<?php echo $row["id"] ?>">Asistencia</a></td>
...
public static function DTablalink3($a,$link,$conexion)
                 ...
                 public static function lasasistencia($a,$link,$conexion)
                {
                                    $query =  mysqli_query($conexion,$a); //parte1
                                      ...
                                      for($i=0;$i<mysqli_num_fields($query);$i++) 
                                      {
                                         ...
                                         echo "<th>Modificar</th></tr></thead><tbody>";
                                         while ($row=mysqli_fetch_assoc($query)) //finparte1
                                       {  
           echo "<tr id=".$row['id'].">"; //hacen las filas
          ...
          ?>
           ...
           <td><a class="btn btn-info btn-sm" data-role="calificar" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $row["id"] ?>">Modificar</a></td>
